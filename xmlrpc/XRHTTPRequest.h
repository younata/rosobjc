...
//  $Id: XRHTTPRequest.h,v 1.3 2003/03/28 13:12:02 znek Exp $
//
...
#ifndef	__XRHTTPRequest_h_INCLUDE
#define	__XRHTTPRequest_h_INCLUDE
...
@interface XRHTTPRequest : XRHTTPMessage
{
	NSString *method;
	NSString *uri;
}
...
#endif	/* __XRHTTPRequest_h_INCLUDE */
