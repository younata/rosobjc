...
//  $Id: XREStruct.h,v 1.3 2003/03/28 13:12:01 znek Exp $
//
...
#ifndef	__XREStruct_h_INCLUDE
#define	__XREStruct_h_INCLUDE
...
@interface XREStruct : XREValue
{
}

@end

#endif	/* __XREStruct_h_INCLUDE */
