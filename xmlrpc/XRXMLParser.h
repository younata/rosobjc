...
//  $Id: XRXMLParser.h,v 1.4 2003/03/28 13:12:02 znek Exp $
//
...
#ifndef	__XRXMLParser_h_INCLUDE
#define	__XRXMLParser_h_INCLUDE


#include <EDCommon/EDCommon.h>


@interface XRXMLParser : EDMLParser
{
}

@end

#endif	/* __XRXMLParser_h_INCLUDE */
