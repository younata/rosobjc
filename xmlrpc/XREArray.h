...
//  $Id: XREArray.h,v 1.3 2003/03/28 13:12:01 znek Exp $
//
...
#ifndef	__XREArray_h_INCLUDE
#define	__XREArray_h_INCLUDE
...
@interface XREArray : XREValue
{
}

@end

#endif	/* __XREArray_h_INCLUDE */
