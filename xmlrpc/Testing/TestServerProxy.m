...
//  $Id: TestServerProxy.m,v 1.2 2003/03/28 13:12:09 znek Exp $
//
...
@implementation TestServerProxy
...
{
    return [[self performMethod:@"testIfTrue" withObject:[NSNumber numberWithBool:candidate]] boolValue];
}
