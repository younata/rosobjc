//
//  XRHTTPResponse+HTTPAuthentication.m
//  XMLRPC
//
//  Created by znek on Tue Jul 09 2002.
//  $Id: XRHTTPResponse+HTTPAuthentication.m,v 1.2 2003/03/28 13:12:02 znek Exp $
//
...
@implementation XRHTTPResponse (HTTPAuthentication)

- (void)setAuthenticationRequest:(id <NSObject, XRHTTPAuthenticationHandler>)authenticator forRealm:(NSString *)realm
{
    [self setHeader:[authenticator challengeForAuthenticationRealm:realm] forKey:@"WWW-Authenticate"];
    [self setStatus:401]; // Unauthorized
    [self setReasonPhrase:@"Unauthorized"];
}
